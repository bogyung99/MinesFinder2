...
public class MinesFinder extends javax.swing.JFrame {
    ...
    private void recordEasyUpdated(RecordTable record) {
        ...
        easyN.setText("Try " + Long.toString(record.gettrr()));
    	}
        saveGameRecords();
    }
    ...
    private void recordMediumUpdated(RecordTable record) {
        ...
        mediumN.setText("Try " + Long.toString(record.gettrr()));
    	}
        saveGameRecords();
    }
    ...
    private void recordHardUpdated(RecordTable record) {
        ...
        hardN.setText("Try " + Long.toString(record.gettrr()));
    	}
        saveGameRecords();
    }
    ...
    private void initComponents() {
        ...
        easyN = new javax.swing.JLabel();
        mediumN = new javax.swing.JLabel();
        hardN = new javax.swing.JLabel();
        

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("MinesFinder"); // 게임 이름
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        setPreferredSize(new java.awt.Dimension(600, 450)); // 창 크기
        setResizable(false);
        ...
        panelBtns.setLayout(new java.awt.GridLayout(2, 3));
        ...
        btnRank.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/technic/apps/minesfinder/resources/랭킹.png"))); // NOI18N
        ...
        panelBtns.add(btnRank);
        
        panelBtns.add(panelRecords);
        
        btnExit.setText("Custom");
        btnExit.setFont(new Font("Gothic",Font.BOLD,40));
    ...
    private void btnEasyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEasyActionPerformed
    	level = 1;
        GameWindow gameWindow = new GameWindow(new Minefield(9, 9, 10), recordEasy ); // 창크기, 지뢰개수
...
//        System.exit(0);
    ...
    static javax.swing.JLabel easyN;
    static javax.swing.JLabel mediumN;
    static javax.swing.JLabel hardN;
